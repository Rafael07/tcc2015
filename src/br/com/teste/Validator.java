...
public class Validator {
	public static boolean validateNotNull(View pView, String pMessage) {
		  ...
		  /*public static boolean validateCPF(String CPF) {
			...
			public final static boolean validateNumeros(String txtNumero){
				if (TextUtils.isEmpty(txtNumero)) {
					return false;
				} else {
					return android.util.Patterns.PHONE.matcher(txtNumero).matches();
				}
			}
